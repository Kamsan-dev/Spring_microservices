package com.kamsan.discoveryservice.security.authentication.client;
...
public class ClientAuthenticationProvider implements AuthenticationProvider {
    ...
    public @Nullable Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!registeredClient.getClientAuthenticationMethods()
                             .contains(clientRefreshTokenAuthentication.getClientAuthenticationMethod())) {
            throw new OAuth2AuthenticationException(new OAuth2Error(OAuth2ErrorCodes.INVALID_CLIENT), "Authentication method is not valid", null);
        }
    ...
    /**
     * Ce provider ne traite que mon type précis d'Authentication.
     *
